...
def depth(topo, i):
    # Depth = ((The minimum of the maximum height to your left and the maximum height to your right) - Current elevation) ## only if this is non-negative
